...
class ParsedMessage {
    public:
		...
		uint32_t instantanous_active_power_import_;
		uint32_t instantanous_active_power_importL1_;
		uint32_t instantanous_active_power_importL2_;
		uint32_t instantanous_active_power_importL3_;
		uint32_t instantanous_active_power_export_;
		uint32_t instantanous_active_power_exportL1_;
		uint32_t instantanous_active_power_exportL2_;
